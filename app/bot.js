...
class Bot {
    ...
    async handleText(event_type, sender_info, webhook_event) {
        ...
        // Direct request for agent through persistent menu or text entry
            ...
            webhook_event.message.text.includes("talk") && webhook_event.message.text.includes("agent") || webhook_event.message.text.includes("support") || webhook_event.message.text.includes("support") && webhook_event.message.text.includes("agent")
        ) {
